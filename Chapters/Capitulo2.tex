...
\begin{figure}[h!]
	\centering
	\subfigure[primer paso del motor.]{\includegraphics[width=0.4\linewidth, height = 7cm]{Imagenes/2/pasoUno}}
	\subfigure[se energiza la bobina C, y el rotor cambia de posición.]{	\includegraphics[width=0.4\linewidth, height = 7cm]{Imagenes/2/pasoDos}}
