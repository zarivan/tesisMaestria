...
\begin{figure}[h]
	\centering
	\subfigure[Espectro del LED violeta, 400nm]{\includegraphics[width=0.48\linewidth, height=5cm]{Imagenes/4/UV400}}
	\subfigure[Acercamiento a los máximos.]{\includegraphics[width=0.48\linewidth,height=5cm]{Imagenes/4/UV400m}}
...
\begin{figure}[h]
	\centering
	\subfigure[LED rojo $\lambda$]{\includegraphics[width=0.48\linewidth, height=5cm]{Imagenes/4/rojot}}
	\subfigure[Acercamiento a los máximos]{\includegraphics[width=0.48\linewidth, height=5cm]{Imagenes/4/rojom}}
...
\begin{figure}[h]
	\centering
	\subfigure[Espectro del LED rojo $\lambda$=700nm]{\includegraphics[width=0.8\linewidth,height=7cm]{Imagenes/4/r700}}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth,height=6cm]{Imagenes/4/ls-rojo}
	\caption{Espectro de la lámpara LS-1-CAL y el LED rojo $\lambda$ =700nm.}
	\label{fig:ls-rojo}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth,height=6cm]{Imagenes/4/pasotam}
...
En la figura \ref{fig:ls-s-ds} se observa el espectro de la lámpara de tungsteno-halógeno. En azul es la medición con el sistema desarrollado y en rojo los valores de la lámpara con base en el ''\textit{datasheet}''. Esta comparación nos muestra como en puntos con mayor intensidad de la lámpara LS-1-CAL el sistema desarrollado pierde sensibilidad hasta el punto de ser incapaz de detectar la irradiancia de la lámpara.  

\begin{figure}[h]
	\centering
	\includegraphics[width=0.85\linewidth, height = 8cm]{Imagenes/4/LS-S-DS}
...
\begin{figure}[h!]
	\centering
	\subfigure[Espectro de la lámpara LS-1-CAL en unidades relativas.]{\includegraphics[width=0.4\linewidth, height = 5cm]{Imagenes/4/LS-potencia}}
	\subfigure[Espectro de lámpara LS-1-CAL normalizado.]{\includegraphics[width=0.4\linewidth,height = 5cm]{Imagenes/4/LS-potNor}}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{Imagenes/4/ajusteEnForma}
...
Al utilizar este ajuste de forma en la medición del LED rojo de 700nm se observa que su pico de emisión ya aparece de manera correcta a los 700nm, ver figura \ref{fig:ledrojoa}. Aún que a mayor longitud de onda se tiene que el ajuste ya no es óptimo por la baja sensibilidad del sistema desarrollado. 

Dado que la lámpara LS-1-CAL tiene un intervalo de emisión de los 300nm en adelante y nuestro sistema tiene baja sensibilidad para medir arriba de los 700 nm tenemos como resultado que este ajuste de forma solo nos sirve en un intervalo de 300nm a 700nm. El sistema desarrollado es capaz de detectar longitudes de onda menores a 300 nm por lo cuál se decide colocar la opción de utilizar o no este ajuste de forma con un botón dentro de la interfaz gráfica. Al realizar mediciones de espectros de línea de emisión menores a 600nm no es necesario usar el ajuste, si solo se quiere localizar las líneas en su longitud de onda. Al medir longitudes de ondas de entre 300 y 700 nm se recomienda activar el ajuste de forma para garantizar que en longitudes de ondas mayores a 600nm el espectro no sea medido con un error y así evitar el problema de corrimiento del espectro.
%\newpage
\begin{figure}[]
	\centering
	\includegraphics[width=0.7\linewidth,height=6cm]{Imagenes/4/LEDrojoA}
